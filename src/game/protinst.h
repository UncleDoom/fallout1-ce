...
//
// All logic now lives in ObjectInstance, ObjectActions, and ObjectLockState.
// These wrappers delegate to the classes so that existing call sites across
// the codebase remain unchanged.
// -------------------------------------------------------------------------
