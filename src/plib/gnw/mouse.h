...
inline constexpr int MOUSE_DEFAULT_CURSOR_WIDTH = 8;
inline constexpr int MOUSE_DEFAULT_CURSOR_HEIGHT = 8;
#define MOUSE_DEFAULT_CURSOR_SIZE (MOUSE_DEFAULT_CURSOR_WIDTH * MOUSE_DEFAULT_CURSOR_HEIGHT)

inline constexpr int MOUSE_STATE_LEFT_BUTTON_DOWN = 0x01;
inline constexpr int MOUSE_STATE_RIGHT_BUTTON_DOWN = 0x02;

inline constexpr int MOUSE_EVENT_LEFT_BUTTON_DOWN = 0x01;
inline constexpr int MOUSE_EVENT_RIGHT_BUTTON_DOWN = 0x02;
inline constexpr int MOUSE_EVENT_LEFT_BUTTON_REPEAT = 0x04;
inline constexpr int MOUSE_EVENT_RIGHT_BUTTON_REPEAT = 0x08;
inline constexpr int MOUSE_EVENT_LEFT_BUTTON_UP = 0x10;
inline constexpr int MOUSE_EVENT_RIGHT_BUTTON_UP = 0x20;
...
inline constexpr int MOUSE_EVENT_WHEEL = 0x40;

inline constexpr int BUTTON_REPEAT_TIME = 250;
